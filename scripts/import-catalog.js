 ...
 *
 * - `ui`     → tests/ui/journey-*      (a browser screen drives it)
 * - `device` → tests/api/journey-*     (handheld/kiosk capture; no web screen,
 *                                       so it is driven through the sync API)
 * - `calc`   → tests/workflow/journey-*(a calculation verified against data,
 *                                       set up via preconditions)
 */
const SURFACE = {
